package com.sit.abbra.abbraapi.wsservice.v1.admin.depannounce;
...
import com.sit.abbra.abbraapi.core.admin.depannounce.DepAnnounceManager;
...
@Path("/api/admin/depannounce")
public class AdminDepAnnounceWS extends CommonWS {
	...
	public Response initSearch(@Context HttpServletRequest request, String jsonReq) {
		...
		try {
			...
			DepAnnounceManager manager = new DepAnnounceManager(getLogger());
